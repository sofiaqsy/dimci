...
public class Activity_Register extends AppCompatActivity {
    ...
    @BindView(R.id.link_login) Button _loginLink;
    ...
    public boolean validate() {
        ...
        if (name.isEmpty() || name.length() < 3) {
            _nameText.setError("Usuario no Valido");
            valid = false;
        } else {
        ...
        if (mobile.isEmpty() || mobile.length()!=9) {
            _mobileText.setError("Ingrese un numero de móvil valido");
            valid = false;
        } else {
